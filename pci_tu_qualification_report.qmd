...
This repo contains the qualification analysis for the PCI AAV8 TU assay. The assay quantifies infectivity of AAV8 on *HeLaRC32* cells. Reporter gene expression is measured using flow cytometry (as %GFP+ cells) and used to calculate TU/mL.

## Setup:

-   2 runs, 2 plates per run
-   Each run has:
    -   **5X Dilution series AAV8** Sample
    -   **1.6X Dilution series AAV8** Sample
